#ifndef _ROS_robotin_project_RAW_VEL_h
#define _ROS_robotin_project_RAW_VEL_h
...
namespace robotin_project
{
  ...
  class RAW_VEL : public ros::Msg
  {
    ...
    const char * getType(){ return "robotin_project/RAW_VEL"; };
